...
const steps = [
    { n: '01', icon: Lightbulb, title: 'شارك فكرتك', body: 'اقترح تحسيناً أو خدمة جديدة عبر نموذج بسيط، يطّلع عليها فريقنا خلال أيام معدودة.' },
    { n: '02', icon: Vote, title: 'صوّت وقيّم', body: 'أعطِ نجوماً واترك تعليقاً على المقترحات المنشورة لتُرشَّح الأفكار الأكثر تأثيراً.' },
    { n: '03', icon: Sparkles, title: 'نُحوّلها إلى واقع', body: 'نختار المقترحات الأعلى تفاعلاً لتدخل ضمن خطّة التطوير، ونُعلمك بكل قرار.' },
];
